  ...
  return (
    ...
    >
      ...
      >
        ...
        <section
          style={{ marginTop: '20px', display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '30px' }}
        >
          {/* Account Settings */}
          <div
            style={{
          ...
          >
            <h2 style={{ color: '#7757FF', marginBottom: '20px' }}>Account Settings (Kang CLAIVE)</h2>
            <button
            ...
            {showUpdateProfileForm && (
              <div style={{ marginTop: '20px' }}>
                <h3 style={{ color: '#7757FF', marginBottom: '10px' }}>Update Profile Information</h3>
                <form>
            ...
            {showChangePasswordForm && (
              <div style={{ marginTop: '20px' }}>
                <h3 style={{ color: '#7757FF', marginBottom: '10px' }}>Change Password</h3>
                <form>
                  <div style={{ marginBottom: '15px' }}>
          ...
          >
            <h2 style={{ color: '#7757FF', marginBottom: '20px' }}>Notification Preferences (Kang MICHAEL)</h2>
            <form>
              <div style={{ marginBottom: '15px' }}>
                <input type="checkbox" id="emailNotifications" name="emailNotifications" defaultChecked />
                <label htmlFor="emailNotifications" style={{ marginLeft: '10px', fontSize: '16px' }}>
                  Email Notifications
                </label>
              </div>
              <div style={{ marginBottom: '15px' }}>
                <input type="checkbox" id="pushNotifications" name="pushNotifications" defaultChecked />
                <label htmlFor="pushNotifications" style={{ marginLeft: '10px', fontSize: '16px' }}>
                  Push Notifications
                </label>
              </div>
            </form>
        ...
        <section
          style={{ marginTop: '40px', display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '30px' }}
        >
          {/* Notifications */}
          <div
            style={{
          ...
          >
            <h2 style={{ color: '#7757FF', marginBottom: '20px' }}>Notifications (Kang MICHAEL)</h2>
            {/* List of notifications (placeholder data) */}
            <ul style={{ listStyleType: 'none', padding: 0 }}>
              <li style={{ marginBottom: '15px' }}>
                <strong>New Announcement:</strong> Campus will be closed tomorrow.
                <br />
                <em style={{ color: '#777' }}>Today at 9:00 AM</em>
              </li>
              <li>
                <strong>Event Reminder:</strong> Seminar on Software Development starts in 2 hours.
                <br />
          ...
          >
            <h2 style={{ color: '#7757FF', marginBottom: '20px' }}>Search History (Kang CLAIVE)</h2>
        ...
        >
          ...
          >
            <h2 style={{ color: '#7757FF', marginBottom: '20px' }}>Recent Locations (Kang MATHLEE)</h2>
          ...
          >
            <h2 style={{ color: '#7757FF', marginBottom: '20px' }}>Feedback Submitted (Kang BRENT)</h2>
        ...
        <section style={{ marginTop: '40px' }}>
          ...
          >
            <h2 style={{ color: '#7757FF', marginBottom: '20px' }}>My Events (Kang MICHAEL)</h2>
            {/* Organized Events */}
            <div style={{ marginBottom: '20px' }}>
              ...
              <ul style={{ listStyleType: 'none', padding: 0 }}>
                <li>
                  <strong>Study Group Meeting</strong> at Library Room 101 on Oct 10th, 3:00 PM
                </li>
              </ul>
            </div>
            ...
            <div>
              ...
              <ul style={{ listStyleType: 'none', padding: 0 }}>
                <li style={{ marginBottom: '15px' }}>
                  <strong>Seminar on Software Development</strong> at Auditorium on Oct 12th, 10:00 AM
                </li>
                <li>
                  <strong>Campus Cleanup Drive</strong> at Main Grounds on Oct 15th, 8:00 AM
                </li>
              </ul>
            </div>
          </div>
        ...
        {user.role === 'Staff' || user.role === 'Administrator' ? (
          ...
          >
            ...
            >
              <h2 style={{ color: '#7757FF', marginBottom: '20px' }}>Managed Campus Services (Kang TERRENCE)</h2>
            ...
            >
              <h2 style={{ color: '#7757FF', marginBottom: '20px' }}>Announcements Posted (Kang CLAIVE)</h2>
              {/* Placeholder data for announcements */}
              <ul style={{ listStyleType: 'none', padding: 0 }}>
                <li style={{ marginBottom: '15px' }}>
                  <strong>System Maintenance Scheduled</strong>
                  <br />
                  Content: The campus network will undergo maintenance on Oct 20th.
                  <br />
                  Posted on: Oct 10th
                </li>
                <li>
        ...
        <section style={{ marginTop: '40px' }}>
          ...
          >
            <h2 style={{ color: '#7757FF', marginBottom: '20px' }}>Incident Reports (Kang TERENCE)</h2>
            {/* List of incident reports (placeholder data) */}
            <ul style={{ listStyleType: 'none', padding: 0 }}>
              <li style={{ marginBottom: '15px' }}>
                <strong>Maintenance Issue:</strong> Broken door handle in Lecture Hall 2.
                <br />
